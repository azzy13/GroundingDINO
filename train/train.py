...
def get_args_parser():
    ...
    # # ---------- LOSS / MATCHER / EVAL ARGS ----------
    # parser.add_argument("--matcher_type", default="HungarianMatcher", type=str,
    #                     help="Matcher to use: HungarianMatcher or SimpleMinsumMatcher")

    # # costs used by the matcher
    ...
    # # focal loss hyperparams (used by matcher & criterion)
    # parser.add_argument("--focal_alpha", default=0.25, type=float)
    # parser.add_argument("--focal_gamma", default=2.0,  type=float)

    # # enable/disable aux losses from decoder intermediate layers
    # parser.add_argument("--aux_loss", action="store_true", default=False)

    # # criterion weights (used in groundingdino.py when building weight_dict)
    ...
    # # whether to drop intermediate box loss
    # parser.add_argument("--no_interm_box_loss", action="store_true", default=False)

    # # mask losses (usually unused for GroundingDINO but referenced in some forks)
    ...
    # # (optional) NMS for post-process (some forks read this)
    # parser.add_argument("--nms_iou_threshold", default=-1, type=float,
    #                     help="If >0, apply NMS with this IoU during postprocess; -1 to disable")
    # parser.add_argument("--num_select", default=300, type=int,
    #                 help="Top-K boxes to keep per image at inference")
